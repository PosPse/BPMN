...
parser.add_argument("--node_emb_alpha", type=float, default="1.0", help="节点嵌入中，节点本身嵌入的权重")
parser.add_argument("--node_type_emb_beta", type=float, default="0.5", help="节点嵌入中，节点类型嵌入的权重")
