...
class Tokenizer():
    def __init__(self, llm_model:str, device:torch.device, the_way_of_emb_new_token:str = 'mean', the_way_of_token_emb:str = 'cls', the_way_of_fussion_node_emb:str = 'sum', node_emb_alpha:float = 1.0, node_type_emb_beta:float = 0.5) -> None:
        '''
