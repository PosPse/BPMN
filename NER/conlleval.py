...
def get_result(correct_chunks, true_chunks, pred_chunks,
    ...
    print("共有 %i 个 token，其中有 %i 个短语; " % (sum_true_counts, sum_true_chunks), end='')
    print("共有: %i 个 短语; 正确数: %i.\n" % (sum_pred_chunks, sum_correct_chunks), end='')

    print("其中，非O的token准确率: %6.2f%%; (non-O)" % (100 * nonO_correct_counts / nonO_true_counts))
    print("综合准确率: %6.2f%%; " % (100 * sum_correct_counts / sum_true_counts), end='')
    print("预测正确率: %6.2f%%; 召回率: %6.2f%%; FB1: %6.2f" % (prec, rec, f1))
    print("开始分类统计")
    ...
    for t in chunk_types:
        ...
        print("%17s: " % t, end='')
        print("预测正确率: %6.2f%%; 召回率: %6.2f%%; FB1: %6.2f" %
              (prec, rec, f1), end='')
